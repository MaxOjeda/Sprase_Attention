...
def train(args):
    ...
    model = KnowformerLightningModule(
        ...
        rala_kv=args.rala_kv,
        rala_phi=args.rala_phi,
        pairnorm_qk=args.pairnorm_qk,
        qk_anchor_head=args.qk_anchor_head,
        qk_pe=args.qk_pe,
        qk_pe_walk_len=args.qk_pe_walk_len,
        qk_pe_kind=args.qk_pe_kind,
        qk_pe_groups=args.qk_pe_groups,
        qk_pe_lap_k=args.qk_pe_lap_k,
        qk_pe_readout=args.qk_pe_readout,
        cpa_k=args.cpa_k,
        cpa_compose=args.cpa_compose,
        cpa_mode=args.cpa_mode,
        cpa_random_pivots=args.cpa_random_pivots,
        cpa_v_layer=args.cpa_v_layer,
        cpa_center=args.cpa_center,
        rerank_k=args.rerank_k,
        rerank_layers=args.rerank_layers,
        rerank_heads=args.rerank_heads,
        rerank_weight=args.rerank_weight,
        rerank_pair_bias=args.rerank_pair_bias,
        rerank_pair_shuffle=args.rerank_pair_shuffle,
    )
